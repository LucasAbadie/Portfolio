...
export const projects: Project[] = [
    ...
    },
    {
        ...
        name: "Sifter",
        description:
            "Explorez, pillez et survivez dans des lieux maudits pour racheter votre liberté.",
        categories: [
            "Game",
            "Formation",
            "UnrealEngine",
        ...
        content: {
            ...
            competences: [
                ...
                },
                {
                    ...
                    skills: [
                        "Perforce",
                        "Gestion collaborative des assets",
                        "Documentation technique",
                    ],
                },
                {
    ...
    },
    {
        ...
        name: "RecovR",
        description:
            "Le jeu vidéo catalyseur de diversité et d'inclusion au travail.",
        categories: [
            "Game",
            "Entreprise",
            "Web",
