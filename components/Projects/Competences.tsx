...
import { CodeIcon, PuzzleIcon, BrainIcon, LightbulbIcon } from "lucide-react";
  ...
  return (
    <section className="pt-20 pb-40 px-4 bg-gradient-to-b from-neutral-900 to-black">
      <div className="container mx-auto mb-20 text-center">
        <h3 className="text-xl mb-2 font-bold uppercase">Build with Purpose</h3>
        <h1 className="text-4xl mb-8">Compétences mises en œuvre</h1>
        <p className="mx-auto w-full px-4 text-white/50 font-neutral text-lg lg:w-11/12 lg:px-20 whitespace-pre-line">
