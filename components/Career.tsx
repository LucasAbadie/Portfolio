...
export default function Career() {
    ...
    const steps = [
        ...
        },
        {
            ...
            type: "CDI",
            description:
                "Co-fondateur, Lead Tech, et Game Developer",
        },
        {
            number: "03",
            title: "JungleVR",
        ...
        },
        {
            ...
            type: "Stage (6 mois)",
            description:
                "Réalisation d'un système de géolocalisation indoor pour chariot connecté.",
        },
        {
            number: "05",
            title: "Appolonia",
        ...
        },
        {
            ...
            type: "Stage (2 mois)",
            description:
                "Réalisation d’un menu d’administrateur (Web) pour machine à sous",
        },
    ];
                            ...
                            >
                                ...
                                <div
                                    className={`${
                                        ...
                                        index % 2 === 0
                                            ? "md:max-w-sm md:inline-block"
                                            : "max-w-sm"
                                        }`}
                                >
                                    <p
                                        className="text-white/30 italic bold mb-1"
                                    >
                                        {step.type}
                                    </p>
