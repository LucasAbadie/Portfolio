            ...
            <div className="container mx-auto px-4 md:px-8 relative z-10">
                ...
                >
                    ...
                    <div className="flex flex-col md:flex-row md:items-end justify-between">
                        ...
                        <Link
                            href="/projects"
                            className="border-2 border-white/20 px-6 py-3 mr-8 text-sm uppercase tracking-widest text-white/80 hover:border-white hover:text-white hover:bg-white/5 transition-all duration-300 flex items-center group"
                        >
                    ...
                    {spotlights.map((project, index) => (
                        ...
                        >
                            <div className="relative aspect-[4/3] overflow-hidden border-2 border-white/20 mb-4 group-hover:border-white/50 transition-all duration-300">
                                <Image
                                    src={project.banner? project.banner + "?height=600&width=800" : "/assets/placeholder.svg"}
                                    alt={project.name}
                                    fill
