...
export default function Hero() {
  ...
  return (
    <section className="relative lg:h-screen flex items-center px-10 py-[100px] sm:py-[110px] overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            >
              Découvrez mes projets en développement, web, et Game dev, ainsi que ma vision et mon
            ...
            >
              ...
              >
                <div className="absolute inset-0 flex items-center justify-center">
                  <Image
                    src="/favicon.svg"
                    alt="Logo Lucas Abadie representant un ours avec un casque de musique et une cravate."
                    width={800}
                    height={800}
                  />
                </div>
