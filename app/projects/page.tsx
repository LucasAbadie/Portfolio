 ...
 * Projects Page
 *
 * Displays all portfolio projects in a grid layout.
 * Each project card shows:
 * - Banner image with grayscale-to-color hover effect
 * - Project name and date
 * - Hover overlay with "View project" prompt
 */
export default function Projects() {
  return (
    <main className="bg-black text-white">
      ...
      {/* TODO: Extract gallery grid into reusable component */}
      {/* TODO: Add scroll-triggered animations for project cards */}
